<?php
    ...
    $edit_id = $_SESSION['st_id'];

    $edit_sql = "SELECT * FROM st_detail WHERE st_id='{$edit_id}'";
  ...
  <body class="d-flex flex-column h-100">
    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
          ...
          <!--  <div class="form-group">
                    <label for="is_deleted">1 is Deleted</label>
                    <input type="number" name="is_deleted" class="form-control" value="<?php echo $row['is_deleted']; ?>">
                </div>  -->
                <div class="form-group">
                    <label for="is_deleted">1 is Deleted</label>  
                    <select class="form-control" name="is_deleted">
                        <option value="0" <?php if($row['is_deleted']=='0') {echo 'selected';}?>>0</option>
                        <option value="1" <?php if($row['is_deleted']=='1') {echo 'selected';}?>>1</option> 
                    </select>
                </div>
