<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $output.='<p><a href="http://localhost:8080/Internship/Day_10/P1_CRUD_Operation_&_Email_Response/active.php?st_email='.$_POST['st_email'].'&uniqid='.$uniqid.'" target="_blank">Click Me!</a></p>'; 
